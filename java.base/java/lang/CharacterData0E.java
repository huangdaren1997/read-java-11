...
class CharacterData0E extends CharacterData {
  ...
  // java GenerateCharacter -string -plane 14 -template make/data/characterdata/CharacterData0E.java.template -spec make/data/unicodedata/UnicodeData.txt -specialcasing make/data/unicodedata/SpecialCasing.txt -proplist make/data/unicodedata/PropList.txt -o build/bootcycle-build/support/gensrc/java.base/java/lang/CharacterData0E.java -usecharforbyte 11 4 1
