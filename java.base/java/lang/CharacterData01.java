...
class CharacterData01 extends CharacterData {
  ...
  // java GenerateCharacter -string -plane 1 -template make/data/characterdata/CharacterData01.java.template -spec make/data/unicodedata/UnicodeData.txt -specialcasing make/data/unicodedata/SpecialCasing.txt -proplist make/data/unicodedata/PropList.txt -o build/bootcycle-build/support/gensrc/java.base/java/lang/CharacterData01.java -usecharforbyte 11 4 1
