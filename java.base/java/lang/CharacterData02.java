...
class CharacterData02 extends CharacterData {
  ...
  // java GenerateCharacter -string -plane 2 -template make/data/characterdata/CharacterData02.java.template -spec make/data/unicodedata/UnicodeData.txt -specialcasing make/data/unicodedata/SpecialCasing.txt -proplist make/data/unicodedata/PropList.txt -o build/bootcycle-build/support/gensrc/java.base/java/lang/CharacterData02.java -usecharforbyte 11 4 1
