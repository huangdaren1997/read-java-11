...
class CharacterDataLatin1 extends CharacterData {
  ...
  // java GenerateCharacter -template make/data/characterdata/CharacterDataLatin1.java.template -spec make/data/unicodedata/UnicodeData.txt -specialcasing make/data/unicodedata/SpecialCasing.txt -proplist make/data/unicodedata/PropList.txt -o build/bootcycle-build/support/gensrc/java.base/java/lang/CharacterDataLatin1.java -usecharforbyte -latin1 8
